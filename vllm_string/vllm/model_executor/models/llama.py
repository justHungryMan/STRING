...
from vllm.attention import Attention, AttentionMetadata, StringAttention
...
class LlamaAttention(nn.Module):
    def __init__(
            ...
            string_config: Optional[Dict[str,
                                                       Any]] = None) -> None:
        super().__init__()
    ...
    def forward(
        ...
        if self.string_config is None:
            ...
            q_diag, q_shifted, k = self.rotary_emb(positions, q, k)
            attn_output = self.attn(q_diag, q_shifted, k, v, kv_cache,
                                    attn_metadata)
