...
def main():
    if args.tokenizer_path[-1] == "/":
        args.tokenizer_path = args.tokenizer_path[:-1]
    open_source_model = args.tokenizer_path.split("/")[-1]
    args.subset = f"{open_source_model}-{args.max_seq_length}"
